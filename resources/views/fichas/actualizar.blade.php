    ...
    <div class="px-5 md:px-32 py-2">
        <div class="bg-gray-50 rounded-md shadow-md px-8 py-5">
            ...
            <form action="{{ url('/importar/aprendices') }}" method="POST" enctype="multipart/form-data" class="">
                ...
                {{--Ficha--}}
                <div class="w-full">
                    <x-input-label for="ficha" :value="__('Seleccione la ficha a actualizar')" class="mb-1 ml-3" />
                    <select 
                        name="ficha"
                        id="ficha" 
                ...
                {{--Aprendices--}}
                <div class="mt-4">
                    <x-input-label for="trimestre" :value="__('Seleccione la lista de aprendices para actualizar')" class="ml-2"/>
                    <input 
                        type="file" 
                        name="documento" 
                        id="documento"
