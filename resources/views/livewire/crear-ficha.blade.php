<div class="bg-gray-50 rounded-md shadow-md px-8 py-5">
    <h1 class="font-bold text-center text-2xl text-gray-900">Crear ficha</h1>
    ...
    <form class="" wire:submit.prevent='crearFicha'>
        ...
        <div class="mt-1">
            ...
            <x-text-input 
                ...
                wire:model="programa"
                :value="old('programa')"
                placeholder="Ingresé nombre del programa de formación"
            />{{--En livewire en ves de poner name="" ponemos wire:model="" para que se comunique con el backend--}}
        ...
        {{-- <div class="mt-1">
            ...
            <option value="AI - Automatización industrial">AI - Automatización industrial</option>
            <option value="DIAM - Diseño e Integración de Automatismos industriales">DIAM - Diseño e Integración de Automatismos industriales</option>
            <option value="GRPP - Gestión de recursos en plantas de producción">GRPP - Gestión de recursos en plantas de producción</option>
            </select>
