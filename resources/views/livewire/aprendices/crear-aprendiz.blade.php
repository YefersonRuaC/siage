<div class="bg-gray-50 rounded-md shadow-md px-4 md:px-8 py-5">
    <h1 class="font-bold text-center text-2xl text-gray-900">Crear aprendiz</h1>
    
    <div class="border-b border-gray-300 my-5"></div>

    <form class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-1" wire:submit.prevent='crearAprendiz'>
