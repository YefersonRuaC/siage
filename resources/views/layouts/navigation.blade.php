                    ...
                    <x-slot name="content">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link 
                                ...
                                class="text-red-700 hover:bg-red-100 font-bold uppercase flex gap-1 justify-center items-center"
                            >
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('aprendiz.index')" :active="request()->routeIs('aprendiz.index')">
                        {{ __('Index') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('aprendiz.index')" :active="request()->routeIs('aprendiz.index')">
                {{ __('Index') }}
            </x-responsive-nav-link>
        </div>
